  ...
  try {
    ...
    playerInstance.on("ready", () => {
      ...
      channelList.forEach((e, i) => {
        ...
        cnImage.src = '/refs/heads/main/canales/' + (e.img || 'canal.webp')
...
const setProgramInfo = async (channelInfo) => {
  ...
  const updateProgramInfo = (programInfo) => {
    ...
    programInfoElement.querySelector('.programImage .channelImage').src = `/refs/heads/main/canales/${(channelInfo.img || 'canal.webp')}`
